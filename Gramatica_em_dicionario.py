...
SET_TYPE_IN_LAST_TABLE = AcaoSemantica(set_lexeme_or_throw_error, [IDENT, "lexeme"])
...
SET_RESULT_LEXEME = AcaoSemantica(set_lexeme, [RESULT, "lexeme"])
SET_RESULT_FIRST_TYPE = AcaoSemantica(set_variable_type_based_on_ident, [RESULT, "first_type", RESULT, "lexeme", "type", RESULTX, "depth"])
...
SET_LVALUE_TYPE = AcaoSemantica(set_variable_type_based_on_ident, [LVALUE, "type", IDENT, "lexeme", "type", APPNUM, "depth"])
...
Producoes = {
"PROGRAM" : [[SET_STATEMENT_FOR_STAT_TO_FALSE, STATEMENT], [FUNCLIST], [EPSILON]],
"FUNCLIST" : [[FUNCDEF, FUNCLISTX]],
"FUNCLIST\'" : [[FUNCLIST], [EPSILON]],
"FUNCDEF" : [[DEF, SET_IDENT_LEXEME, IDENT, SET_TYPE_IN_LAST_TABLE, CREATE_SCOPE, OPEN_PARENTHESIS, PARAMLIST, CLOSING_PARENTHESIS, OPEN_CURLY_BRACKET, STATELIST, CLOSE_SCOPE, CLOSING_CURLY_BRACKET]],
...
"STATEMENT" : [[VARDECL, SEMICOLON], [ATRIBSTAT, SEMICOLON], [PRINTSTAT, SEMICOLON], [READSTAT, SEMICOLON], [RETURNSTAT, SEMICOLON], [IFSTAT], [FORSTAT], [OPEN_CURLY_BRACKET, CREATE_SCOPE, SET_FOR_OF_TS, STATELIST, CLOSE_SCOPE, CLOSING_CURLY_BRACKET], [BREAK, SEMICOLON], [SEMICOLON]],
"TYPE" : [[INT, SET_TYPE_INT], [FLOAT, SET_TYPE_FLOAT], [STRING, SET_TYPE_STRING]],
"VARDECL" : [[SET_INDEX_INITIAL_DEPTH_UNTIL_NOW, TYPE, SET_IDENT_LEXEME, IDENT, SET_TYPE_IN_LAST_TABLE, INDEX, INSERT_VARIABLE_TYPE_INTO_TABLE_WITH_INDEX]],
...
"ATRIBSTAT" : [[LVALUE, SET_ATRIBSTAT_FIRST_TYPE, EQUALS, RESULT, SET_ATRIBSTAT_TYPE_BASED_ON_FIRST_TYPE_OR_THROW_ERROR]],
"RESULT" : [[SIGN, FACTOR, CREATE_EXPR_FACTOR_NODE, EXPR, SET_RESULT_NODE, SET_RESULT_TYPE_BASED_ON_FACTOR_OR_THROW_ERROR], [FACTORX, CREATE_EXPR_FACTORX_NODE, EXPR, SET_RESULT_NODE, SET_RESULT_TYPE_BASED_ON_FACTORX_OR_THROW_ERROR], [SET_RESULT_LEXEME, IDENT, CREATE_RESULTX_IDENT_NODE, RESULTX, SET_RESULT_FIRST_TYPE, SET_RESULT_FROM_RESULTX_FINAL_NODE, SET_RESULT_TYPE_OR_THROW_ERROR], [ALLOCEXPRESSION]],
...
"PARAMLISTCALL" : [[SET_IDENT_LEXEME, IDENT, SET_TYPE_IN_LAST_TABLE, PARAMLISTCALLX], [EPSILON]],
"PARAMLISTCALL\'" : [[COMMA, PARAMLISTCALL], [EPSILON]],
"PRINTSTAT" : [[PRINT, EXPRESSION]],
"READSTAT" : [[READ, LVALUE]],
"RETURNSTAT" : [[RETURN, IDENT]],
"IFSTAT" : [[IF, OPEN_PARENTHESIS, EXPRESSION, CLOSING_PARENTHESIS, SET_STATEMENT_FOR_STAT_TO_FALSE, STATEMENT, MORESTAT, ENDIF]],
"MORESTAT" : [[ELSE, SET_STATEMENT_FOR_STAT_TO_FALSE, STATEMENT], [EPSILON]],
"FORSTAT" : [[FOR, OPEN_PARENTHESIS, ATRIBSTAT, SEMICOLON, EXPRESSION, SEMICOLON, ATRIBSTAT, CLOSING_PARENTHESIS, SET_STATEMENT_FOR_STAT_TO_TRUE, STATEMENT]],
"STATELIST" : [[SET_STATEMENT_FOR_STAT_TO_FALSE, STATEMENT, MORESTATELIST]],
...
"EXPRESSION" : [[NUMEXPRESSION, SET_MORENUMEXP_FIRST_NODE_BASED_ON_NUMEXPRESSION, MORENUMEXP, SET_EXPRESSION_FROM_MORENUMEXP_NODE, SET_EXPRESSION_TYPE_OR_THROW_ERROR]],
...
"LVALUE" : [[SET_IDENT_LEXEME, IDENT, SET_APPNUM_DEPTH_ZERO, APPNUM, CREATE_LVALUE_IDENT_NODE, SET_LVALUE_TYPE]],
...
LL1Action = [
    [SET_STATEMENT_FOR_STAT_TO_FALSE, STATEMENT],
    [FUNCLIST],
    [EPSILON],
    [FUNCDEF, FUNCLISTX],
    [FUNCLIST],
    [EPSILON],
    [DEF, SET_IDENT_LEXEME, IDENT, SET_TYPE_IN_LAST_TABLE, CREATE_SCOPE, OPEN_PARENTHESIS, PARAMLIST, CLOSING_PARENTHESIS, OPEN_CURLY_BRACKET, STATELIST, CLOSE_SCOPE, CLOSING_CURLY_BRACKET],
    [TYPE, SET_IDENT_LEXEME, IDENT, SET_TYPE_IN_LAST_TABLE, INSERT_VARIABLE_TYPE_INTO_TABLE_WITHOUT_INDEX, PARAMLISTX],
    [EPSILON],
    [COMMA, PARAMLIST],
    [EPSILON],
    [VARDECL, SEMICOLON],
    ...
    [IFSTAT],
    [FORSTAT],
    [OPEN_CURLY_BRACKET, CREATE_SCOPE, SET_FOR_OF_TS, STATELIST, CLOSE_SCOPE, CLOSING_CURLY_BRACKET],
    [BREAK, VERIFY_BREAK_INSIDE_FOR, SEMICOLON],
    [SEMICOLON],
    [INT, SET_TYPE_INT],
    [FLOAT, SET_TYPE_FLOAT],
    [STRING, SET_TYPE_STRING],
    [SET_INDEX_INITIAL_DEPTH_UNTIL_NOW, TYPE, SET_IDENT_LEXEME, IDENT, SET_TYPE_IN_LAST_TABLE, INDEX, INSERT_VARIABLE_TYPE_INTO_TABLE_WITH_INDEX],
    ...
    [LVALUE, SET_ATRIBSTAT_FIRST_TYPE, EQUALS, RESULT, SET_ATRIBSTAT_TYPE_BASED_ON_FIRST_TYPE_OR_THROW_ERROR],
    ...
    [SET_RESULT_LEXEME, IDENT, CREATE_RESULTX_IDENT_NODE, RESULTX, SET_RESULT_FROM_RESULTX_FINAL_NODE, SET_RESULT_FIRST_TYPE, SET_RESULT_TYPE_OR_THROW_ERROR],
    [ALLOCEXPRESSION],
    ...
    [SET_IDENT_LEXEME, IDENT, SET_TYPE_IN_LAST_TABLE, PARAMLISTCALLX],
    [EPSILON],
    [COMMA, PARAMLISTCALL],
    [EPSILON],
    [PRINT, EXPRESSION],
    [READ, LVALUE],
    [RETURN, IDENT],
    [IF, OPEN_PARENTHESIS, EXPRESSION, CLOSING_PARENTHESIS, SET_STATEMENT_FOR_STAT_TO_FALSE, STATEMENT, MORESTAT, ENDIF],
    [ELSE, SET_STATEMENT_FOR_STAT_TO_FALSE, STATEMENT],
    [EPSILON],
    [FOR, OPEN_PARENTHESIS, ATRIBSTAT, SEMICOLON, EXPRESSION, SEMICOLON, ATRIBSTAT, CLOSING_PARENTHESIS, SET_STATEMENT_FOR_STAT_TO_TRUE, STATEMENT],
    [SET_STATEMENT_FOR_STAT_TO_FALSE, STATEMENT, MORESTATELIST],
    [STATELIST],
    [EPSILON],
    ...
    [NUMEXPRESSIONS],
    [EPSILON],
    [NUMEXPRESSION, SET_MORENUMEXP_FIRST_NODE_BASED_ON_NUMEXPRESSION, MORENUMEXP, SET_EXPRESSION_FROM_MORENUMEXP_NODE, SET_EXPRESSION_TYPE_OR_THROW_ERROR],
    ...
    [SET_IDENT_LEXEME, IDENT, SET_APPNUM_DEPTH_ZERO, APPNUM, CREATE_LVALUE_IDENT_NODE, SET_LVALUE_TYPE],
