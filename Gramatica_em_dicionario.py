...
"RESULT" : [[SIGN, FACTOR, CREATE_EXPR_FACTOR_NODE, EXPR, SET_RESULT_NODE], [FACTORX, CREATE_EXPR_FACTORX_NODE, EXPR, SET_RESULT_NODE], [IDENT, CREATE_RESULTX_IDENT_NODE, RESULTX, SET_RESULT_FROM_RESULTX_FINAL_NODE], [ALLOCEXPRESSION]],
"RESULT\'" : [[APPNUM, CREATE_EXPR_RESULTX_NODE, EXPR, SET_RESULTX_FINAL_NODE], [OPEN_PARENTHESIS, PARAMLISTCALL, CLOSING_PARENTHESIS]],
...
LL1Action = [
    ...
    [IDENT, CREATE_RESULTX_IDENT_NODE, RESULTX, SET_RESULT_FROM_RESULTX_FINAL_NODE],
    [ALLOCEXPRESSION],
    [APPNUM, CREATE_EXPR_RESULTX_NODE, EXPR, SET_RESULTX_FINAL_NODE],
