...
SET_FACTORX_LEXEME = AcaoSemantica(set_lexeme, [FACTORX, "lexemes"])
CREATE_FACTORX_NODE = AcaoSemantica(create_node_lexeme, [FACTORX, "node", FACTORX, "lexemes", None, None])
...
LL1Action = [
    ...
    [SET_FACTORX_LEXEME, INT_CONSTANT, CREATE_FACTORX_NODE, SET_FACTORX_INT_TYPE],
    [SET_FACTORX_LEXEME, FLOAT_CONSTANT, CREATE_FACTORX_NODE, SET_FACTORX_FLOAT_TYPE],
