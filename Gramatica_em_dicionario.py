...
"FUNCDEF" : [[DEF, SET_IDENT_LEXEME, IDENT, SET_TYPE_IN_LAST_TABLE, CREATE_SCOPE, OPEN_PARENTHESIS, PARAMLIST, CLOSING_PARENTHESIS, OPEN_CURLY_BRACKET, STATELIST, CLOSE_SCOPE, CLOSING_CURLY_BRACKET, RESET_IDENT_LEXEME]],
...
"LVALUE" : [[SET_IDENT_LEXEME, IDENT, SET_APPNUM_DEPTH_ZERO, APPNUM, CREATE_LVALUE_IDENT_NODE, SET_LVALUE_TYPE, RESET_IDENT_LEXEME]],
...
LL1Action = [
    ...
    [FUNCLIST],
    [EPSILON],
    [DEF, SET_IDENT_LEXEME, IDENT, SET_TYPE_IN_LAST_TABLE, CREATE_SCOPE, OPEN_PARENTHESIS, PARAMLIST, CLOSING_PARENTHESIS, OPEN_CURLY_BRACKET, STATELIST, CLOSE_SCOPE, CLOSING_CURLY_BRACKET, RESET_IDENT_LEXEME],
    ...
    [SET_IDENT_LEXEME, IDENT, SET_APPNUM_DEPTH_ZERO, APPNUM, CREATE_LVALUE_IDENT_NODE, SET_LVALUE_TYPE, RESET_IDENT_LEXEME],
