...
"STATEMENT" : [[VARDECL, SEMICOLON], [ATRIBSTAT, SEMICOLON], [PRINTSTAT, SEMICOLON], [READSTAT, SEMICOLON], [RETURNSTAT, SEMICOLON], [IFSTAT], [FORSTAT], [OPEN_CURLY_BRACKET, CREATE_SCOPE, STATELIST, CLOSE_SCOPE, CLOSING_CURLY_BRACKET], [BREAK, SEMICOLON], [SEMICOLON]],
...
LL1Action = [
    ...
    [IFSTAT],
    [FORSTAT],
    [OPEN_CURLY_BRACKET, CREATE_SCOPE, STATELIST, CLOSE_SCOPE, CLOSING_CURLY_BRACKET],
    [BREAK, SEMICOLON],
    [SEMICOLON],
    [INT, SET_TYPE_INT],
