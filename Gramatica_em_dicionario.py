...
"FUNCDEF" : [[DEF, SET_IDENT_LEXEME, IDENT, SET_TYPE_IN_LAST_TABLE, OPEN_PARENTHESIS, PARAMLIST, CLOSING_PARENTHESIS, OPEN_CURLY_BRACKET, CREATE_SCOPE, STATELIST, CLOSE_SCOPE, CLOSING_CURLY_BRACKET]],
...
LL1Action = [
    ...
    [FUNCLIST],
    [EPSILON],
    [DEF, SET_IDENT_LEXEME, IDENT, SET_TYPE_IN_LAST_TABLE, OPEN_PARENTHESIS, PARAMLIST, CLOSING_PARENTHESIS, OPEN_CURLY_BRACKET, CREATE_SCOPE, STATELIST, CLOSE_SCOPE, CLOSING_CURLY_BRACKET],
